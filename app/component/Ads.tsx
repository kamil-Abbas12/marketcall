...
const Ads = () => {
  return (
    <section
      ...
      style={{
        background:
          "linear-gradient(160deg, #f5f3ff 0%, #fdf4ff 50%, #eff6ff 100%)",
      }}
    >
      {/* Background glow */}
      <div
      ...
      <div className="max-w-6xl mx-auto px-6 relative z-10">
        ...
        >
          ...
          <p className="text-gray-500 w-full mx-auto text-md md:text-base">
            Real impact from real campaigns. Discover how Marketcall empowers
            ...
            return (
              <motion.div
                ...
                style={{
                  ...
                  boxShadow:
                    "0 4px 24px rgba(124,58,237,0.06), 0 1px 4px rgba(0,0,0,0.04)",
                }}
                variants={{
              ...
              >
                ...
                <div
                  ...
                  style={{
                    background:
                      "linear-gradient(135deg, rgba(124,58,237,0.1), rgba(192,38,211,0.1))",
